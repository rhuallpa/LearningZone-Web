...
export const Navbar = () => {
  return (
    <div className="relative p-4 border-b h-20 flex items-center bg-[#13161C] shadow-sm">
      {/* Contenedor para la imagen ajustada al navbar */}
      <div className="absolute inset-y-0 left-0 h-full w-auto bg-[#13161C] flex items-center">
        <Image 
          src="/img77.png" 
